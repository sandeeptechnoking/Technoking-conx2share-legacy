...
public class GroupFollowersInviteActivity extends BaseActionBarActivity {

    private static final String TAG = GroupFollowersInviteActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_follower_invite);
        if (savedInstanceState == null) {
            ...
            Fragment fragment = GroupFollowersInviteFragment.newInstance();
            Bundle args = new Bundle();
            args.putInt("GroupId", mGroup.getId()); // TODO - Extract to constant
            fragment.setArguments(args);
            FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
            ft.add(R.id.group_followers_fragment_content, fragment).commit();
        }
    }
}
